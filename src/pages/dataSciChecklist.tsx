...
const generateItems = (): Item[] => {
  const itemNames = [
    ...
    'MATH342',
    'PHIL223',
    'Computation And Inferential Depth 1',
    'Computation And Inferential Depth 2',
    'Computation And Inferential Depth 3',
    'Domain Area Core 1',
    'Domain Area Core 2',
    'Domain Area Elective 1',
    'Domain Area Elective 2',
    'Domain Area Elective 3',
    'Domain Area Elective 4',
  ];
    ...
    <div style={{ backgroundColor: '#fbf4cf', padding: '20px', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
      ...
      >
        <h1 style= {{ color: 'darkgreen', textAlign: 'center', marginBottom: '50px' }}>
          Data Science Courses Checklist
        </h1>
      </div>
      <table>
        <thead>
